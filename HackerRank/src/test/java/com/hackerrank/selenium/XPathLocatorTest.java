...
import com.hackerrank.selenium.XPathLocator;
...
public class XPathLocatorTest {
    ...
    public static void setup() {
	  ...
	  public String absoluteXPathForInput(WebDriver driver , String pagUrl) {
	  
	  String locator ="//html//div//input"; return locator; }
	  
	  public String relativeXPathForInput(WebDriver driver , String pagUrl) {
	  
	  String locator ="//div//input"; return locator; 
	 }
